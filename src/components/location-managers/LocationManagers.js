...
const locationManagers = [
  ...
  },
  {
    ...
    age: 20,
    experience: '5 წელი მარკეტინგში',
    bio: 'ანდრეა ლალიაშვილი არის Video360 Studio-ს ლოკაციის მენეჯერი და გაყიდვების სპეციალისტი. ის პასუხისმგებელია კომპანიის პროდუქტის ადგილზე გაყიდვებზე, კლიენტების მოზიდვაზე და მათ მომსახურებაზე. ანდრეა უზრუნველყოფს სტუმრების საუკეთესო გამოცდილებას და აქტიურად მონაწილეობს ლოკაციის პოპულარიზაციაში.',
